    ...
    <>
      <AppBar
        ...
        sx={{
          ...
          maxHeight: "160px",
          color: "black",
          transition: showHideSearchWidget
            ? "maxHeight 250ms linear  "
            : "height 200ms ",
        }}
      >
        <Toolbar
          ...
          {!showHideSearchWidget ? (
            <Paper
              ...
              sx={{
                ...
                alignContent: "center",
                alignItems: "center",
                marginLeft: { xs: "5%", sm: "10%", md: "5%", lg: "5%" },
                cursor: "pointer",
              }}
              p={2}
            >
            ...
            <Box sx={{ width: "30%", height: "45px" }}>
              ...
              >
                <Tab
                  ...
                  wrapped
                  sx={{
                    fontWeight: `${value === "one" ? "bold" : "normal"}`,
                    fontSize: "14px",
                  }}
                />
                <Tab
                  ...
                  label="Experiences"
                  sx={{
                    fontWeight: `${value === "two" ? "bold" : "normal"}`,
                    fontSize: "14px",
                  }}
                />
              </Tabs>
