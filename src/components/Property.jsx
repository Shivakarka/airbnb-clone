...
const Property = () => {
  return (
    <Box className="flex flex-col  w-fit gap-3 mb-3 mt-5 mx-auto">
      <img
        ...
        alt="property"
        className="rounded-xl h-[270px] w-[280px] object-cover"
      />
      <Box>
        <Typography variant="body1"> Go VIP with Kevin Hart</Typography>
